  ...
  useEffect(() => {
    if (loggedInEmail) {
      setLocalProducts([
        {
          id: 1,
          title: "Luxury Pen .243 Gold",
          price: "349.00",
          category: "Pens",
          image: "https://243pen.store/assets/img/pen-gold.jpg",
        },
        {
          id: 2,
          title: "Luxury Pen .243 Silver",
          price: "299.00",
          category: "Pens",
          image: "https://243pen.store/assets/img/pen-silver.jpg",
        },
      ]);
    }
  }, [loggedInEmail]);
  ...
  return (
    <Layout>
      ...
      {loggedInEmail && !showOrders && !showProducts && (
        <TopLeftPopup style={{ maxWidth: 400, padding: "2rem" }}>
          <b>{loggedInEmail}</b>
          {timeLeft !== null && (
            <p>
              sesja: <b>{formatTime(timeLeft)}</b>
            </p>
          )}
